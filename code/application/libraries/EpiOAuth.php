...
class EpiOAuth
{
     ...
     * un modified signature (public function __construct($consumerKey, $consumerSecret, $signatureMethod = 'HMAC-SHA1'){})
     *
     * @param $config
     * @internal param $consumerKey
     * @internal param $consumerSecret
     * @internal param string $signatureMethod
     */
    public function __construct($config)
    {
        ...
        $signatureMethod = ((isset($config[2])))?$config[2] : 'HMAC-SHA1';
